...
One naive solution may be handled by a change in the similarity measure used in the last step of the algorithm by using weighted sum in the components of the similarity measure. %, or different similarity measure for the different cues
